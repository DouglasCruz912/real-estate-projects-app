...
async def create_project(
    ...
    try:
        ...
        # Combinar datos del proyecto con datos comerciales
...
async def get_projects(
    ...
    try:
        ...
        # Combinar datos de cada proyecto con su información comercial
        ...
        return ProjectListResponse(
            projects=projects_with_commercial,
            total=total,
            page=(skip // limit) + 1,
            per_page=limit,
...
# Nota: Los endpoints comerciales separados han sido eliminados
# Toda la información comercial ahora se maneja a través de los endpoints de Project
